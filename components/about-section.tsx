...
export function AboutSection() {
  return (
    <section className="py-24 lg:py-32 bg-neutral-100" id="about">
      <div className="container-custom">
        {/* Main About Block */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          <Reveal>
            <div>
              <p className="text-sm uppercase tracking-[0.3em] text-amber-600 mb-4">About BGW Doors</p>
        ...
        <div className="text-center mb-16">
          <Reveal>
            <p className="text-sm uppercase tracking-[0.3em] text-amber-600 mb-4">Why BGW</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Reveal delay={0.1}>
            ...
            >
              ...
              <h4 className="text-xl font-medium text-neutral-900 mb-3">Craftsmanship</h4>
          ...
          <Reveal delay={0.2}>
            ...
            >
              ...
              <h4 className="text-xl font-medium text-neutral-900 mb-3">Premium Materials</h4>
              <p className="text-neutral-600 leading-relaxed">
          ...
          <Reveal delay={0.3}>
            ...
            >
              ...
              <h4 className="text-xl font-medium text-neutral-900 mb-3">Dedicated Support</h4>
              <p className="text-neutral-600 leading-relaxed">
